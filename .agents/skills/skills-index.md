...
| inno-figure-gen | `.agents/skills/inno-figure-gen/SKILL.md` | Generate/edit images with Nano Banana Pro (Gemini 3 Pro Image). Use for image create/modify requests incl. edits. Sup... |
